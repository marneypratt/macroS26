...
You can refer back to the dataviz project and look at the effectSize_YourNamte.qmd QUarto document (or your rendered PDF version) to help remind you about how to choose the correct effect size test. Copy all the code from the appropriate script template and paste it below.
