...
-   **title**: replace YourName in the title with your name (no spaces). This will ensure that your PDF file gets named correctly when you render this file
...
We will go back to the slideshow and talk about how the data were collected before looking at the data.
...
To look at the structure of a data frame that was just imported, click on the object name (=name of the data frame) in the Global Environment as a shortcut to using the View() function, and click on the blue arrow next to the data frame in the Global Environment to see all the variable names and types. If you prefer, you can also type `View(macros)` in the console (change the name in the parentheses to match the dataset you want to view).
...
Often, the density value is very skewed - are the points lining up close to the line for your data? Are the points linear or wavy/curved?
...
While the points may not line up perfectly on the line, does the log-transformation make the data more normally distributed? If so, then **make sure to graph density on a log-scaled axis** going forward.
...
Does it look like the density of your organism is different or similar upstream vs downstream of Paradise Pond? Let's do an effect size test to see if the density is significantly impacted by location.

### Calculate the effect size of location

To calculate the appropriate effect size. Go to the **script_templates folder** and then select the **inference** subfolder.

You can refer back to the dataviz project and look at the effectSize_YourName.qmd Quarto document (or your rendered PDF version) to help remind you about how to choose the correct effect size test. Copy all the code from the appropriate script template and paste it below.
...
From the effect size test output, write the following down in your lab notebook so you will have it all to include in your results:
...
ggsave(filename = "results/LocationWithEffectSize.png",  
...
The above code will save your new joined graph that includes the density by location graph along with the effect size results. The name if this file is "LocationWithEffectSize.png", and it will appear in the "results" subfolder of the main project folder under the Files tab in the lower right quadrant of this window.

If you are working on the Smith server, you will first need to export this file to your computer:

-   Check the box next to the "LocationWithEffectSize.png" file (find this in the results subfolder)
...
Make sure to insert this combined graph into your results slides and write a figure legend in the speaker notes (see the assignment handout for more details).
...
-   Check the box next to the "cor.plot.png" file (find this in the results subfolder)

-   Go to the "More" menu with the gear icon and click the drop down arrow

-   Select "Export" and then save the file to your computer

Make sure to insert this graph into your results slides and write a figure legend in the speaker notes (see the assignment handout for more details).
...
-   Check the box next to the "strongest.cor.plot.png" file (find this in the results subfolder)
